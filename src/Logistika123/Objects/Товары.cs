...
namespace IIS.Logistika123
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika123.ЕдИзм fЕдиницыИзмер;
        ...
        public virtual IIS.Logistika123.ЕдИзм ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Logistika123.ЕдИзм result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Logistika123.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Logistika123.Товары));
                }
            }
        }
    }
