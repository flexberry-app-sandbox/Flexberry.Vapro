...
namespace IIS.Vapro
{
    ...
    public class ДокумПоставки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Vapro.Организация fОрганизация;
        
        private IIS.Vapro.Клиенты fКлиенты;
        
        private IIS.Vapro.DetailArrayOfИнфОЗаказе fИнфОЗаказе;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Vapro.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Vapro.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Vapro.Организация Организация
        {
            get
            {
                ...
                IIS.Vapro.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Vapro.DetailArrayOfИнфОЗаказе ИнфОЗаказе
        {
            get
            {
                ...
                {
                    this.fИнфОЗаказе = new IIS.Vapro.DetailArrayOfИнфОЗаказе(this);
                }
                IIS.Vapro.DetailArrayOfИнфОЗаказе result = this.fИнфОЗаказе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиE", typeof(IIS.Vapro.ДокумПоставки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиL", typeof(IIS.Vapro.ДокумПоставки));
                }
            }
        }
    }
